...
public class quiz1Partie2Activity extends AppCompatActivity {
    ...
    private void checkAnswer() {
        ...
        if (selectedId != -1) {
            ...
            // Réponse correcte
            String correctAnswer = "Aucune de ces réponses n’est vraie.";
            ...
            if (userAnswer.equalsIgnoreCase(correctAnswer)) { // Vérifie la réponse
                ...
                Toast.makeText(quiz1Partie2Activity.this, "Succès", Toast.LENGTH_SHORT).show();

                // Redirige vers la page suivante
                Intent intent = new Intent(quiz1Partie2Activity.this, quiz2Partie2Activity.class); // Remplace NextActivity par la suivante dans le quiz
                startActivity(intent);
                finish(); // Termine l'activité actuelle
            } else {
                // Affiche le message "Faux"
                Toast.makeText(quiz1Partie2Activity.this, "Faux", Toast.LENGTH_SHORT).show();
            }
        } else {
            // Demande à l'utilisateur de sélectionner une option
            Toast.makeText(quiz1Partie2Activity.this, "Veuillez sélectionner une option", Toast.LENGTH_SHORT).show();
        }
    }}
