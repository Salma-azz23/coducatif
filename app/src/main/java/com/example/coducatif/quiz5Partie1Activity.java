...
public class quiz5Partie1Activity extends AppCompatActivity {
    ...
    private void checkAnswer() {
        ...
        if (selectedId != -1) {
            ...
            // Réponse correcte
            String correctAnswer = "Dans js/components/";
            ...
            if (userAnswer.equalsIgnoreCase(correctAnswer)) { // Vérifie la réponse
                ...
                Toast.makeText(quiz5Partie1Activity.this, "Succès", Toast.LENGTH_SHORT).show();

                // Redirige vers la page suivante
                Intent intent = new Intent(quiz5Partie1Activity.this, quiz6Partie1Activity.class); // Remplace NextActivity par la suivante dans le quiz
                startActivity(intent);
                finish(); // Termine l'activité actuelle
            } else {
                // Affiche le message "Faux"
                Toast.makeText(quiz5Partie1Activity.this, "Faux", Toast.LENGTH_SHORT).show();
            }
        } else {
            // Demande à l'utilisateur de sélectionner une option
            Toast.makeText(quiz5Partie1Activity.this, "Veuillez sélectionner une option", Toast.LENGTH_SHORT).show();
        }
    }
}
