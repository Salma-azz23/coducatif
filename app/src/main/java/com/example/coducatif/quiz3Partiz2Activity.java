...
public class quiz3Partiz2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz3_partiz2);
    ...
    private void checkAnswer() {
        ...
        if (selectedId != -1) {
            ...
            // Réponse correcte
            String correctAnswer = " Un module bundler";
            ...
            if (userAnswer.equalsIgnoreCase(correctAnswer)) { // Vérifie la réponse
                ...
                Toast.makeText(quiz3Partiz2Activity.this, "Succès", Toast.LENGTH_SHORT).show();

                // Redirige vers la page suivante
                Intent intent = new Intent(quiz3Partiz2Activity.this, quiz4Partie2Activity.class); // Remplace NextActivity par la suivante dans le quiz
                startActivity(intent);
                finish(); // Termine l'activité actuelle
            } else {
                // Affiche le message "Faux"
                Toast.makeText(quiz3Partiz2Activity.this, "Faux", Toast.LENGTH_SHORT).show();
            }
        } else {
            // Demande à l'utilisateur de sélectionner une option
            Toast.makeText(quiz3Partiz2Activity.this, "Veuillez sélectionner une option", Toast.LENGTH_SHORT).show();
        }
    }}
